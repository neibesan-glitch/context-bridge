...
> [!TIP]
> **Utilisation avec Obsidian** : Ouvrez le dossier racine de ce projet dans Obsidian pour voir le graphe de relations entre ces fichiers de documentation et vos fichiers de code source.
