# Consignes Système pour l'Assistant IA (Antigravity)

Bonjour ! Si vous êtes une IA démarrant une nouvelle session de développement sur ce projet, vous devez suivre scrupuleusement ces consignes de démarrage pour économiser les tokens et respecter le contexte du projet.
...
3. **Consultez la mémoire des erreurs** : Ouvrez [docs/journal/journal_erreurs.md](../docs/journal/journal_erreurs.md) pour vous assurer de ne pas répéter des erreurs passées résolues par l'équipe.
...
* **Activité de session** : Ajoutez un log de ce qui a été fait dans `docs/journal/journal_bord.md` avant de terminer votre intervention.
